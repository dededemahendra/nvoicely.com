...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "border border-black/10 bg-primary text-primary-foreground shadow-[inset_0_1px_0_0_rgba(255,255,255,0.2),inset_0_-2px_0_0_rgba(0,0,0,0.18),0_1px_2px_0_rgba(0,0,0,0.2),0_5px_12px_-3px_rgba(0,0,0,0.3)] hover:brightness-110 active:translate-y-px active:shadow-[inset_0_2px_4px_0_rgba(0,0,0,0.35)]",
